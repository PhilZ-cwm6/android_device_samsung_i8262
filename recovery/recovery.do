...
on init-recovery
	...
	unmount /data
	exec -f "/system/bin/e2fsck -v -y <dev_node:/data>"
...
on factory-out
	...
	cp -y -r -v -f --with-fmode=0664 --with-dmode=0775 --with-owner=media_rw.media_rw /preload/sdcard0/ /data/media/
	unmount /data
	mount /data
	cmp -r /preload/sdcard0/ /data/media/
